...
class AnnotationsEditStep(pipeline_step.PipelineStep):
    """
    Item upload step creator
    """

    def __init__(self, step_dict=None):
        super(AnnotationsEditStep, self).__init__()
        self.name = 'AnnotationsEdit'
    ...
    def execute(self, pipeline_dict):
        ...
        # run
        outputs = item.annotations.edit(**kwargs)
