...
class ArtifactsDownloadStep(pipeline_step.PipelineStep):
    """
    Item download step creator
    """

    def __init__(self, step_dict=None):
        super(ArtifactsDownloadStep, self).__init__()
        self.name = 'ArtifactsDownload'
    ...
    def execute(self, pipeline_dict):
        ...
        outputs = project.artifacts.download(**kwargs)
