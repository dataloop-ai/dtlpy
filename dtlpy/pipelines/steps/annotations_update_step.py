...
class AnnotationsUpdateStep(pipeline_step.PipelineStep):
    """
    Item upload step creator
    """

    def __init__(self, step_dict=None):
        super(AnnotationsUpdateStep, self).__init__()
        self.name = 'AnnotationsUpdate'
    ...
    def execute(self, pipeline_dict):
        ...
        # run
        outputs = item.annotations.update(**kwargs)
