...
class GetAnnotationsStep(pipeline_step.PipelineStep):
    """
    Annotations get step creator
    """

    def __init__(self, step_dict=None):
        super(GetAnnotationsStep, self).__init__()
        self.name = 'GetAnnotations'
        ...
        if step_dict is not None:
            ...
            self.inputs = [{'name': 'item', 'from': 'item', 'type': 'object'}]
            self.kwargs = {}
