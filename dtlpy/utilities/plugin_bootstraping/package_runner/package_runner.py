...
import dtlpy as PlatformInterface
from dtlpy.entities.project import Project
from ..util import load_json_from_file
from dtlpy.utilities.state_manager import get_state
...
class PackageRunner:
    ...
    def run_local_project(self, dlp):
        cwd = os.getcwd()
    ...
    def get_mainpy_run_function():
        main_location = os.path.join(os.getcwd(), "src", "main.py")
        spec = importlib.util.spec_from_file_location("main.py", main_location)
