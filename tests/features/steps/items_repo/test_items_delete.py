...
def step_impl(context):
    assert len(context.dataset.items.list(filters=context.dl.Filters(itemType='file')).items) == 0
...
def step_impl(context):
    assert len(context.dataset.items.list(filters=context.dl.Filters(itemType='file')).items) == context.item_count
