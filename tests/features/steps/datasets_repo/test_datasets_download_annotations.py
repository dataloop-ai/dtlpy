...
def step_impl(context, item_path):
    ...
    context.item = context.dataset.items.upload(filepath=item_path)
...
def step_impl(context):
    ...
    labels = [entities.Label.from_root(root) for root in labels]
...
def step_impl(context):
    context.project.datasets.download_annotations(dataset_name=context.dataset.name,
