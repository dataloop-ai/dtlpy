Feature: Items repository download annotations testing
  ...
  Scenario: Download item annotations with mask
    ...
    When I download items annotations from item with "mask" to "downloaded_annotations/mask.png"
  ...
  Scenario: Download item annotations with instance
    ...
    And There are no files in folder "downloaded_annotations"
    And Item is annotated with annotations in file: "assets_split/annotations_download/0162_annotations.json"
    When I download items annotations from item with "instance" to "downloaded_annotations/instance.png"
  ...
  Scenario: Download item annotations with json
    ...
    And There are no files in folder "downloaded_annotations"
    And Item is annotated with annotations in file: "assets_split/annotations_download/0162_annotations.json"
    When I download items annotations from item with "json" to "downloaded_annotations/json.json"
  ...
  Scenario: Download item annotations with img_mask
    ...
    And There are no files in folder "downloaded_annotations"
    And Item is annotated with annotations in file: "assets_split/annotations_download/0162_annotations.json"
    When I download items annotations from item with "img_mask" to "downloaded_annotations/img_mask.png"
  ...
  Scenario: Download item annotations with vtt
    ...
    And There are no files in folder "downloaded_annotations"
    And Item is annotated with annotations in file: "assets_split/annotations_download/0162_annotations.json"
    When I download items annotations from item with "vtt" to "downloaded_annotations/vtt.vtt"
